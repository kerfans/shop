...
{block name=content}
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="col-lg-11">
            ...
            <fieldset>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_host" style="color: red">货架显示名称<br>（当前名称）</label>
                    <div class="col-sm-4">
                        <input class="form-control" id="ds_host" name="title" type="text" value="{$da['title']}" placeholder="请填入货架显示名称" required/>
                    </div>
                    <label class="col-sm-2 control-label" for="ds_name" style="color: red">代金券数量<br>(当前库存)</label>
                    <div class="col-sm-4">
                        <input class="form-control" id="ds_name" name="stock_num" type="text" value="{$da['stock_num']}" placeholder="请输入代金券数量" required/>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="ds_username" style="color: red">兑换需要积分<br>(当前需求积分)</label>
                    <div class="col-sm-4">
                        <input class="form-control" type="text" value="{$da['cost_points']}" name="cost_points" placeholder="请输入兑换需求积分" required/>
                    </div>
                    <label class="col-sm-2 control-label" for="ds_password" style="color: red" >权重<br>(越大越靠前)</label>
                    <div class="col-sm-4">
                        <input class="form-control" type="text" name="sort" value="{$da['sort']}" placeholder="请输入权重（越大越靠前显示）" required/>
                    </div>
                </div>
            </fieldset>
            <br>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div id="imgdiv"><img id="imgShow" width="300" src="{$da['picture']}" /></div>
